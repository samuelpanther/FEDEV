...
let restartTimeout: number | null = null;   //this hopefully fixes the weird jumping
...
function updateSlide(): void {
    let imageElement = document.getElementById("slideImage") as HTMLImageElement; 
    let captionElement = document.getElementById("caption") as HTMLElement;
...
let playPauseBtn = document.getElementById("playPauseBtn") as HTMLButtonElement;
